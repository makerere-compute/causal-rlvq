...
a = load('./results/lucas0_CRLVQ_0.3.mat','result0');
resu(2,1) = a.result0.Test_error(1,end);

a = load('./results/lucas0_CRLVQ_0.7.mat','result0');
resu(3,1) = a.result0.Test_error(1,end);

a = load('./results/lucas0_CRLVQ_1','result0');
resu(4,1) = a.result0.Test_error(1,end);

a = load('./results/lucas0_CRLVQ_1.3.mat','result0');
...
a = load('./results/lucas1_CRLVQ_0.3.mat','result1');
resu(2,2) = a.result1.Test_error(1,end);

a = load('./results/lucas1_CRLVQ_0.7.mat','result1');
resu(3,2) = a.result1.Test_error(1,end);

a = load('./results/lucas1_CRLVQ_1','result1');
resu(4,2) = a.result1.Test_error(1,end);

a = load('./results/lucas1_CRLVQ_1.3.mat','result1');
...
a = load('./results/lucas2_CRLVQ_0.3.mat','result2');
resu(2,3) = a.result2.Test_error(1,end);

a = load('./results/lucas2_CRLVQ_0.7.mat','result2');
resu(3,3) = a.result2.Test_error(1,end);

a = load('./results/lucas2_CRLVQ_1','result2');
resu(4,3) = a.result2.Test_error(1,end);

a = load('./results/lucas2_CRLVQ_1.3.mat','result2');
